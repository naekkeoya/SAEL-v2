<?php
    ...
    <section class='packages pt-5'>
      		<h2 class='heading text-capitalize text-center'>Registro de Proveedores</h2>
    	<div class='container py-lg-4 py-sm-3 col-sm-6 d-flex flex-row '>

        <fieldset class='fieldset2 container align-items-center'>
          <form action='create_partner.php' method='POST' class='contact'>
            <div class='form-group'>
              <input type='text' class='form-control' id='nombres' name='nombre' placeholder='Nombre' required='' aria-describedby='Nombre'>
            </div>
            <div class='form-group'>
              <input type='text' class='form-control' id='telefonos' name='telefono' placeholder='Telefono' required='' aria-describedby='Telefono'>
            </div>
            <div class='form-group'>
              <input type='text' class='form-control' id='giros' name='giro' placeholder='Giro' required='' aria-describedby='Giro'>
            </div>
            <div class='form-group'>
              <input type='email' class='form-control' id='correos' name='correo' placeholder='Correo' required=''>
            </div>
						<div class='form-group'>
              <input type='text' class='form-control' id='estados' name='estado' placeholder='Estado' required=''>
            </div>
						<div class='form-group'>
              <input type='text' class='form-control' id='ciudades' name='ciudad' placeholder='Ciudad' required=''>
            </div>
						<div class='form-group'>
              <input type='text' class='form-control' id='colonias' name='colonia' placeholder='Colonia' required=''>
            </div>
						<div class='form-group'>
              <input type='text' class='form-control' id='calles' name='calle' placeholder='Calle' required=''>
            </div>
						<div class='form-group'>
              <input type='text' class='form-control' id='numero' name='numero' placeholder='Numero' required=''>
            </div>
            <button type='submit' id='addPartner' class='btn btn-primary btn-lg'> Agregar</button>
          </form>
        </fieldset>
      </div>
    </section>
