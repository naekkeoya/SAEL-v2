    ...
    <section class='packages pt-5'>
        ...
        <fieldset class='fieldset2 container align-items-center'>
          <form action='create_partner.php' method='POST' class='contact'>
            ...
            <div class='form-group'>
              <input type='message' class='form-control' id='descripcion' name='descripcion' placeholder='Descripción' required='' aria-describedby='descipcion'>
            </div>
            <div class='form-group'>
              <input type='text' class='form-control' id='costo' name='costo' placeholder='Costo' aria-describedby='Costo'>
            </div>
            <div class='form-group'>
