	   	...
	   	if ($sesion)
			{
			 ...
			 if (!$partner)
			 {
					 header("location: search_client_delete_fail_search.php");
			 }
			 echo "<!DOCTYPE html>
			 ...
			 <section class='packages pt-5'>
				 ...
				 <div class='container py-lg-4 py-sm-3 col-sm-6 d-flex flex-row '>
					 ...
					 <fieldset class='fieldset2 container align-items-center'>
						 <form action='redelete_client.php' method='POST' class='contact'>
						 <div class='form-group'>
							 ...
							 <div class='form-group'>
								 <input type='email' class='form-control' id='correos' name='correo' placeholder='$partner[4]' readonly='' value = '$partner[4]' required=''>
							 </div>
							 <div class='form-group'>
								 <input type='text' class='form-control' id='telefonos' name='telefono' placeholder='$partner[5]' readonly='' value = '$partner[5]' required=''>
							 </div>
