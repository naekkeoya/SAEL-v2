	<?php
	    ...
	    if ($sesion)
		    ...
		    $tipo = $sesion[3];
 			 ...
 			 if (!$partner)
 			 {
 					 header("location: search_employee_delete_fail_search.php");
 			 }
				echo "<!DOCTYPE html>
		    ...
		    <section class='packages pt-5'>
		      		<h2 class='heading text-capitalize text-center'>Eliminar Empleado</h2>
		    	<div class='container py-lg-4 py-sm-3 col-sm-6 d-flex flex-row '>

		        <fieldset class='fieldset2 container align-items-center'>
		          <form action='redelete_employee.php' method='POST' class='contact'>
							<div class='form-group'>
								<input type='text' class='form-control' id='ids' name='id' placeholder='$partner[0]' readonly='' value = '$partner[0]' required=''>
							</div>
		            <div class='form-group'>
		              <input type='text' class='form-control' id='nombres' name='nombre' placeholder='$partner[1]' readonly='' value = '$partner[1]' required=''>
		            </div>
								<div class='form-group'>
		              <input type='text' class='form-control' id='paterno' name='paterno' placeholder='$partner[2]' readonly='' value = '$partner[2]' required=''>
		            </div>
								<div class='form-group'>
		              <input type='text' class='form-control' id='materno' name='materno' placeholder='$partner[3]' readonly='' value = '$partner[3]' required=''>
		            </div>
								<div class='form-group'>
		              <input type='text' class='form-control' id='fecha' name='fecha' placeholder='$partner[4]' readonly='' value = '$partner[4]' required=''>
		            </div>
								<div class='form-group'>
		              <input type='email' class='form-control' id='correos' name='correo' placeholder='$partner[5]' readonly='' value = '$partner[5]' required=''>
		            </div>
		            <div class='form-group'>
		              <input type='text' class='form-control' id='pass' name='pass' placeholder='$partner[6]' readonly='' value = '$partner[6]' required=''>
		            </div>
								<div class='form-group'>
		              <input type='text' class='form-control' id='tipo' name='tipo' placeholder='$partner[7]' readonly='' value = '$partner[7]' required=''>
		            </div>
