	<?php
	    ...
	    if ($sesion)
		    ...
		    $tipo = $sesion[3];
				...
				if (!$partner)
				{
						header("location: search_promo_delete_fail_search.php");
				}
				echo "<!DOCTYPE html>
		    ...
		    <section class='packages pt-5'>
		      		<h2 class='heading text-capitalize text-center'>Eliminar Promoción</h2>
		    	<div class='container py-lg-4 py-sm-3 col-sm-6 d-flex flex-row '>

		        <fieldset class='fieldset2 container align-items-center'>
		          <form action='redelete_promo.php' method='POST' class='contact'>
		            ...
		            <div class='form-group'>
		              <input type='text' class='form-control' id='nombres' name='nombre' placeholder='$partner[1]' readonly = '' value = '$partner[1]' required=''>
								...
								<div class='form-group'>
		              <input type='text' class='form-control' id='descripcion' name='descripcion' placeholder='$partner[2]'readonly = '' value = '$partner[2]' required=''>
		            </div>
								<div class='form-group'>
		              <input type='text' class='form-control' id='costo' name='costo' placeholder='$partner[3]'readonly = '' value = '$partner[3]' required=''>
		            </div>
