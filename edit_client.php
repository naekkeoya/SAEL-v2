	<?php
	    ...
	    if ($sesion)
		    ...
		    $tipo = $sesion[3];
				...
				if (!$partner)
				{
						header("location: search_client_fail_search.php");
				}
				echo "<!DOCTYPE html>
		    ...
		    <section class='packages pt-5'>
		      		<h2 class='heading text-capitalize text-center'>Editar Cliente</h2>
		    	<div class='container py-lg-4 py-sm-3 col-sm-6 d-flex flex-row '>

		        <fieldset class='fieldset2 container align-items-center'>
		          <form action='recreate_client.php' method='POST' class='contact'>
		            ...
		            <div class='form-group'>
		              <input type='text' class='form-control' id='telefonos' name='telefono' placeholder='$partner[5]' value = '$partner[5]' required='' aria-describedby='Telefono'>
		            </div>
