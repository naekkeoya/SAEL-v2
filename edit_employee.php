	    ...
	    if ($sesion)
			{
				...
				$query = mysqli_query($conexion, "SELECT *FROM usuarios WHERE nombre_usuario = '$busqueda'");
				$partner = mysqli_fetch_array($query);
				if (!$partner)
				{
						header("location: search_employee_fail_search.php");
				}
				echo "<!DOCTYPE html>
				...
				<section class='packages pt-5'>
							<h2 class='heading text-capitalize text-center'>Editar Empleado</h2>
					<div class='container py-lg-4 py-sm-3 col-sm-6 d-flex flex-row '>

						<fieldset class='fieldset2 container align-items-center'>
							<form action='recreate_employee.php' method='POST' class='contact'>
							<div class='form-group'>
								...
								<div class='form-group'>
									<input type='text' class='form-control' id='nombres' name='nombre' placeholder='$partner[1]' value = '$partner[1]' required='' aria-describedby='Nombre'>
								</div>
								<div class='form-group'>
									<input type='text' class='form-control' id='paterno' name='paterno' placeholder='$partner[2]' value = '$partner[2]' required='' aria-describedby='Paterno'>
								</div>
								<div class='form-group'>
									<input type='text' class='form-control' id='materno' name='materno' placeholder='$partner[3]' value = '$partner[3]' required='' aria-describedby='Materno'>
								</div>
								<div class='form-group'>
									<input type='text' class='form-control' id='fecha' name='fecha' placeholder='$partner[4]' value = '$partner[4]' required=''>
								</div>
								<div class='form-group'>
									<input type='email' class='form-control' id='correo' name='correo' placeholder='$partner[5]' value = '$partner[5]' required='' aria-describedby='Telefono'>
								</div>
								<div class='form-group'>
									<input type='text' class='form-control' id='pass' name='pass' placeholder='$partner[6]' value = '$partner[6]' required='' aria-describedby='Telefono'>
								</div>
								<div class='form-group'>
									<input type='text' class='form-control' id='tipo' name='tipo' placeholder='$partner[7]' value = '$partner[7]' required='' aria-describedby='Telefono'>
								</div>
