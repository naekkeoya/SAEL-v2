	    ...
	    if ($sesion)
		    ...
		    $tipo = $sesion[3];
				...
				if ($partner)
				{
					...
					if (!$partner)
					{
						header("location: search_event_fail_search.php");
					}
				}
				else
				{
		    ...
		    <section class='packages pt-5'>
		      		<h2 class='heading text-capitalize text-center'>Editar Evento</h2>
		    	<div class='container py-lg-4 py-sm-3 col-sm-6 d-flex flex-row '>

		        <fieldset class='fieldset2 container align-items-center'>
		          <form action='recreate_event.php' method='POST' class='contact'>
		            ...
		            <div class='form-group'>
		              <input type='text' class='form-control' id='hora' name='hora' placeholder='$partner[5]' value = '$partner[5]' required=''>
		            </div>
								<div class='form-group'>
		              <input type='text' class='form-control' id='duracion' name='duracion' placeholder='$partner[6]' value = '$partner[6]' required=''>
		            </div>
