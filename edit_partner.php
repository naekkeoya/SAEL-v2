	<?php
	    ...
	    if ($sesion)
		    ...
		    $tipo = $sesion[3];
				...
				if (!$partner)
				{
						header("location: search_partner_fail_search.php");
				}
				echo "<!DOCTYPE html>
		    ...
		    <section class='packages pt-5'>
		      		<h2 class='heading text-capitalize text-center'>Editar Proveedor</h2>
		    	<div class='container py-lg-4 py-sm-3 col-sm-6 d-flex flex-row '>

		        <fieldset class='fieldset2 container align-items-center'>
		          <form action='recreate_partner.php' method='POST' class='contact'>
							<div class='form-group'>
								<input type='text' class='form-control' id='ids' name='id' placeholder='$partner[0]' readonly = '' value = '$partner[0]' required=''>
							</div>
		            <div class='form-group'>
		              <input type='text' class='form-control' id='nombres' name='nombre' placeholder='$partner[1]' value = '$partner[1]' required=''>
		            </div>
		            <div class='form-group'>
		              <input type='text' class='form-control' id='telefonos' name='telefono' placeholder='$partner[2]' value = '$partner[2]' required=''>
		            </div>
		            <div class='form-group'>
		              <input type='text' class='form-control' id='giros' name='giro' placeholder='$partner[3]' value = '$partner[3]' required=''>
		            </div>
		            <div class='form-group'>
		              <input type='email' class='form-control' id='correos' name='correo' placeholder='$partner[4]' value = '$partner[4]' required=''>
		            </div>
								<div class='form-group'>
		              <input type='text' class='form-control' id='estados' name='estado' placeholder='$partner[5]' value = '$partner[5]' required=''>
		            </div>
								<div class='form-group'>
		              <input type='text' class='form-control' id='ciudades' name='ciudad' placeholder='$partner[6]' value = '$partner[6]' required=''>
		            </div>
								<div class='form-group'>
		              <input type='text' class='form-control' id='colonias' name='colonia' placeholder='$partner[7]' value = '$partner[7]' required=''>
		            </div>
								<div class='form-group'>
		              <input type='text' class='form-control' id='calles' name='calle' placeholder='$partner[8]' value = '$partner[8]' required=''>
		            </div>
								<div class='form-group'>
		              <input type='text' class='form-control' id='numero' name='numero' placeholder='$partner[9]' value = '$partner[9]' required=''>
		            </div>
		            <button type='submit' id='addPartner' class='btn btn-primary btn-lg'> Guardar Cambios</button>
		          </form>
		        </fieldset>
		      </div>
		    </section>
