	<?php
	    ...
	    if ($sesion)
		    ...
		    $tipo = $sesion[3];
				...
				$query = mysqli_query($conexion, "SELECT *FROM promociones WHERE nombre_promocion = '$busqueda'");
				$partner = mysqli_fetch_array($query);
				if (!$partner)
				{
						header("location: search_promo_fail_search.php");
				}
				echo "<!DOCTYPE html>
		    ...
		    <section class='packages pt-5'>
		      		<h2 class='heading text-capitalize text-center'>Editar Promoción</h2>
		    	<div class='container py-lg-4 py-sm-3 col-sm-6 d-flex flex-row '>

		        <fieldset class='fieldset2 container align-items-center'>
		          <form action='recreate_promo.php' method='POST' class='contact'>
		            ...
		            <div class='form-group'>
		              <input type='text' class='form-control' id='nombres' name='nombre' placeholder='$partner[1]' value = '$partner[1]' required='' aria-describedby='Nombre'>
								...
								<div class='form-group'>
		              <input type='text' class='form-control' id='descripcion' name='descripcion' placeholder='$partner[2]' value = '$partner[2]' required='' aria-describedby='Paterno'>
		            </div>
								<div class='form-group'>
		              <input type='text' class='form-control' id='costo' name='costo' placeholder='$partner[3]' value = '$partner[3]' required='' aria-describedby='Materno'>
		            </div>
