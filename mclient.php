    ...
    if ($sesion)
	    ...
	    <section class='packages pt-5'>
	    	<div class='container py-lg-4 py-sm-3'>
	    		<h2 class='heading text-capitalize text-center'>Módulo Cliente</h2>
	    		<br>
	    		<div class='row'>
	          ...
	          <div class=' col-12'>
	              <div class='row'>
	                <div class='col-sm-6 col-12'>
	                  <div class='card'>
	                    <div class='card-body'>
	                      ...
	                      <p class='card-text'>Permite agregar nuevos clientes.</p>
	                ...
	                <div class='col-sm-6 col-12'>
	                  <div class='card'>
	                    <div class='card-body'>
	                      <h5 class='card-title'>Mostrar Clientes</h5>
	                      <p class='card-text'>Permite ver todos los clientes que se tienen actualmente.</p>
	                      <a href='show_client.php' class='btn btn-primary'>Acceder</a>
	                    </div>
	                  </div>
	                </div>
	              </div>
	                ...
	                <div class='col-sm-6 col-12'>
	                  <div class='card'>
	                    <div class='card-body'>
	                      ...
	                      <p class='card-text'>Permite editar la información de un cliente registrado.</p>
	                      <a href='search_client.php' class='btn btn-primary'>Acceder</a>
	                    </div>
	                  </div>
	                </div>
	                <div class='col-sm-6 col-12'>
	                  <div class='card'>
	                    <div class='card-body'>
	                      ...
	                      <p class='card-text'>Permite eliminar un cliente registrado.</p>
	                      <a href='search_client_delete.php' class='btn btn-primary'>Acceder</a>
	                    </div>
	                  </div>
	                </div>
	              </div>
