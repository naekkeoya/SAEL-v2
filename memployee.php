						...
						<div class=' col-12'>
								...
								<div class='row'>
									...
									<div class='col-sm-6 col-12'>
										<div class='card'>
											<div class='card-body'>
												<h5 class='card-title'>Mostrar Mensajes.</h5>
												<p class='card-text'>Permite ver los mensajes enviados por los clientes.</p>
												<a href='show_messages.php' class='btn btn-primary'>Acceder</a>
											</div>
										</div>
									</div>
								</div>
