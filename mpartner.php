    ...
    if ($sesion)
	    ...
	    <section class='packages pt-5'>
	    	<div class='container py-lg-4 py-sm-3'>
	    		<h2 class='heading text-capitalize text-center'>Módulo Proveedor</h2>
	    		<br>
	    		<div class='row'>
	          ...
	          <div class=' col-12'>
	                ...
	                <div class='col-sm-6 col-12'>
	                  <div class='card'>
	                    <div class='card-body'>
	                      ...
	                      <p class='card-text'>Permite agregar nuevos provedores de servicios.</p>
	                      <a href='add_partner.php' class='btn btn-primary'>Acceder</a>
	                    </div>
	                  </div>
	                </div>
	                <br>
	                <div class='col-sm-6 col-12'>
	                  <div class='card'>
	                    <div class='card-body'>
	                      ...
	                      <p class='card-text'>Permite ver todos los proveedores que se tienen actualmente.</p>
	                      <a href='show_partner.php' class='btn btn-primary'>Acceder</a>
	                    </div>
	                  </div>
	                </div>
	              </div>
	              <div class='row'>
	                <div class='col-sm-6 col-12'>
	                  <div class='card'>
	                    <div class='card-body'>
	                      <h5 class='card-title'>Editar Proveedores</h5>
	                      <p class='card-text'>Permite editar la información de un proverdor registrado.</p>
	                      <a href='search_partner.php' class='btn btn-primary'>Acceder</a>
	                    </div>
	                  </div>
	                </div>
	                <div class='col-sm-6 col-12'>
	                  <div class='card'>
	                    <div class='card-body'>
	                      ...
	                      <p class='card-text'>Permite eliminar un provedor registrado.</p>
	                      <a href='search_partner_delete.php' class='btn btn-primary'>Acceder</a>
	                    </div>
	                  </div>
	                </div>
	              </div>
