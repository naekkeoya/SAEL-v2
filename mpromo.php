    ...
    if ($sesion)
	    ...
	    <section class='packages pt-5'>
	    	<div class='container py-lg-4 py-sm-3'>
	    		<h2 class='heading text-capitalize text-center'>Módulo Promociones y Descuentos</h2>
	    		<br>
	    		<div class='row'>
	          ...
	          <div class=' col-12'>
	              <div class='row'>
	                <div class='col-sm-6 col-12'>
	                  <div class='card'>
	                    <div class='card-body'>
	                      ...
	                      <p class='card-text'>Permite agregar nuevas promociones.</p>
	                      <a href='add_promo.php' class='btn btn-primary'>Acceder</a>
	                    </div>
	                  </div>
	                </div>
	                <br>
	                <div class='col-sm-6 col-12'>
	                  <div class='card'>
	                    <div class='card-body'>
	                      <h5 class='card-title'>Mostrar Promoción</h5>
	                      <p class='card-text'>Permite ver todos las promociones que se tienen actualmente.</p>
	                      <a href='show_promo.php' class='btn btn-primary'>Acceder</a>
	                    </div>
	                  </div>
	                </div>
	              </div>
	                ...
	                <div class='col-sm-6 col-12'>
	                  <div class='card'>
	                    <div class='card-body'>
	                      ...
	                      <p class='card-text'>Permite edita la información de una promoción registrada.</p>
	                      <a href='search_promo.php' class='btn btn-primary'>Acceder</a>
	                    </div>
	                  </div>
	                </div>
	                <div class='col-sm-6 col-12'>
	                  <div class='card'>
	                    <div class='card-body'>
	                      <h5 class='card-title'>Eliminar Promoción.</h5>
	                      <p class='card-text'>Permite eliminar una promoción registrada.</p>
	                      <a href='search_promo_delete.php' class='btn btn-primary'>Acceder</a>
	                    </div>
	                  </div>
	                </div>
	              </div>
