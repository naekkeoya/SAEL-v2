    ...
    if ($sesion)
	    ...
	    <section class='packages pt-5'>
	        ...
	        <fieldset class='fieldset2 container align-items-center'>
					<form action='edit_employee.php' method='POST' class='contact'>
					<div class='form-group'>
						<input type='text' class='form-control' id='busqueda' name='busqueda' placeholder='Nombre del Empleado' required='' aria-describedby='Nombre'>
						<style>
							.alert {
								padding: 20px;
