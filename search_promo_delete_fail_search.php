<?php
    ...
    if ($sesion)
	    ...
	    <section class='packages pt-5'>
	      		<h2 class='heading text-capitalize text-center'>Buscar Promoción</h2>
	    	<div class='container py-lg-4 py-sm-3 col-sm-6 d-flex flex-row '>

	        <fieldset class='fieldset2 container align-items-center'>
					<form action='delete_promo.php' method='POST' class='contact'>
					<div class='form-group'>
						<input type='text' class='form-control' id='busqueda' name='busqueda' placeholder='Nombre De La Promoción' required='' aria-describedby='Nombre'>
						<style>
							.alert {
								padding: 20px;
